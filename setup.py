...
with open("src/semantic_changes/version.py") as fp:
...
setup(
    ...
    version=version,
    description="Library to transform git commit history into semantic changes",
    author="Lyz",
    ...
    package_dir={"": "src"},
    package_data={"semantic_changes": ["py.typed"]},
